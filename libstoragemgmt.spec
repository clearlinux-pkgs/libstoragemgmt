...
Source0  : https://github.com/libstorage/libstoragemgmt/releases/download/1.9.8/libstoragemgmt-1.9.8.tar.gz
...
%prep
%setup -q -n libstoragemgmt-1.9.8
cd %{_builddir}/libstoragemgmt-1.9.8
pushd ..
cp -a libstoragemgmt-1.9.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698425047
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libstoragemgmt.so.1.9.8
/usr/lib64/libstoragemgmt.so.1
/usr/lib64/libstoragemgmt.so.1.9.8

%files libexec
%defattr(-,root,root,-)
/usr/libexec/lsm.d/find_unused_lun.py
/usr/libexec/lsm.d/local_check.py
