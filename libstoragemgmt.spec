...
%prep
%setup -q -n libstoragemgmt-1.10.1
cd %{_builddir}/libstoragemgmt-1.10.1
pushd ..
cp -a libstoragemgmt-1.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721149979
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libstoragemgmt.so.1.10.1
/usr/lib64/libstoragemgmt.so.1
/usr/lib64/libstoragemgmt.so.1.10.1
