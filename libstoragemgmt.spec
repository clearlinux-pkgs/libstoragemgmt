...
Version  : 1.7.0
Release  : 14
URL      : https://github.com/libstorage/libstoragemgmt/releases/download/1.7.0/libstoragemgmt-1.7.0.tar.gz
Source0  : https://github.com/libstorage/libstoragemgmt/releases/download/1.7.0/libstoragemgmt-1.7.0.tar.gz
...
%prep
%setup -q -n libstoragemgmt-1.7.0
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1540741545
...
/usr/lib64/libstoragemgmt.so.1.7.0
